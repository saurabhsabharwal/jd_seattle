...
JHtml::_('stylesheet', 'com_sellacious/view.locations.import.css', array('version' => S_VERSION_CORE, 'relative' => true));
JHtml::_('script', 'com_sellacious/view.locations.import.js', array('version' => S_VERSION_CORE, 'relative' => true));
?>

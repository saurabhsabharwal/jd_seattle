...
<label for="<?php echo $field->id ?>_text" class="form-label2">
	...
	<input type="text" id="<?php echo $field->id ?>_text" name="<?php echo $field->name ?>[t]" value="<?php echo $field->value['t'] ?>" <?php echo $class . $checked . $required . $onclick . $onchange . $disabled ?> />
</label>

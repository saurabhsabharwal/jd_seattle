...
<div class="mod-sellacious-relatedproducts related-grid-layout <?php echo $class_sfx; ?>">
	<?php foreach ($products AS $product):
		...
		$sellers = $helper->product->getSellers($product->id, false);
		$seller  = ModSellaciousRelatedProducts::getCheapestSeller($sellers, $product->id);
		...
		$item->images = $helper->product->getImages($product->id);
		...
		<div class="related-product-wrap-grid">
			<div class="related-product-box <?php echo $splCategoryClass; ?>" data-rollover="container">
				...
				<div class="related-product-info-box">
					...
					{
						?>
						<a href="<?php echo $login_url ?>"><?php echo JText::_('MOD_SELLACIOUS_RELATEDPRODUCTS_PRICE_DISPLAY_LOGIN_TO_VIEW'); ?></a>
						<?php
					}

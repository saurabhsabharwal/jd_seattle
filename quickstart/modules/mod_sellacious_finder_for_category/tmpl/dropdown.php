...
JHtml::_('stylesheet', 'mod_sellacious_finder_for_category/dropdown.css', false, true, false);
...
<script>
	jQuery(document).ready(function ($) {
		...
		$("#sella<?php echo $module->id; ?> .search-category-actionbtn .search-icon").on('click', function () {

...
class ModSellaciousLatestProducts
{
	...
	public static function getSellerInfo($seller_uid)
	{
		...
		{
			$result->seller_mobile = '(' . JText::_('MOD_SELLACIOUS_LATESTPRODUCTS_NO_NUMBER_GIVEN') . ')';
		}
		...
		{
			$result->seller_email = '(' . JText::_('MOD_SELLACIOUS_LATESTPRODUCTS_NO_EMAIL_GIVEN') . ')';
		}

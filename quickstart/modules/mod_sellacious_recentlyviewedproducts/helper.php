...
class ModSellaciousRecentlyViewedProducts
{
	...
	public static function getSellerInfo($seller_uid)
	{
		...
		{
			$result->seller_mobile = '(' . JText::_('MOD_SELLACIOUS_RECENTLYVIEWEDPRODUCTS_NO_NUMBER_GIVEN') . ')';
		}
		...
		{
			$result->seller_email = '(' . JText::_('MOD_SELLACIOUS_RECENTLYVIEWEDPRODUCTS_NO_EMAIL_GIVEN') . ')';
		}

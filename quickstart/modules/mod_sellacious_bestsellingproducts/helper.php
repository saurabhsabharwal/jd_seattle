...
class ModSellaciousBestSellingProducts
{
	public static function getSellerInfo($seller_uid)
	{
		...
		{
			$result->seller_mobile = '(' . JText::_('MOD_SELLACIOUS_BESTSELLINGPRODUCTS_NO_NUMBER_GIVEN') . ')';
		}
		...
		{
			$result->seller_email = '(' . JText::_('MOD_SELLACIOUS_BESTSELLINGPRODUCTS_NO_EMAIL_GIVEN') . ')';
		}

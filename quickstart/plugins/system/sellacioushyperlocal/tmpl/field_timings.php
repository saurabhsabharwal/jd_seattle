		...
		<tr role="row" class="cursor-pointer v-top">
			<th class="nowrap">
				<label>
					...
					<span style="margin-left: 5px;"><strong><?php echo JText::_('PLG_SYSTEM_SELLACIOUSHYPERLOCAL_FIELD_TIMINGS_CHECK_ALL');?></strong></span>
				</label>
			</th>
			<th class="nowrap text-center"><?php echo JText::_('PLG_SYSTEM_SELLACIOUSHYPERLOCAL_FIELD_TIMINGS_START_TIME');?></th>
			<th class="nowrap text-center"><?php echo JText::_('PLG_SYSTEM_SELLACIOUSHYPERLOCAL_FIELD_TIMINGS_END_TIME');?></th>
			<th></th>
		</tr>
		</thead>
		<tbody>
			...
			<tr role="row" id="jform_slabs_price_slabs_sfssrow_0" class="sfssrow">
				<td class="text-align-left">
					<label>
						...
						<span style="margin-left: 5px;"><?php echo $day;?></span>
					</label>
				</td>
				<td>
					<?php
				...
				<td class="text-align-center">
					<label>
						...
						<span style="margin-left: 5px;"><?php echo JText::_('PLG_SYSTEM_SELLACIOUSHYPERLOCAL_FIELD_TIMINGS_FULL_DAY'); ?></span>
					</label>
				</td>
			</tr>
			<?php
